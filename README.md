...
- USTx are made in a newer version of OpenUTAU (beta), as such older versions of OpenUTAU (such as the stable release) may not be able to open the project.
  - Please use Utaformatix to convert the USTx to an older version if you encounter any issues.
